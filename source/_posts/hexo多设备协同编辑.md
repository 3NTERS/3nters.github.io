...
因为查看主页`header`属性为`<class="full_page" id="page-header">`而文章`header`则是`<class="post-page" id=“page-header”>`所以`css`直接根据属性来设置了，其他界面属性`<class="not-home-page" id="page-header">`也同样设置为透明
